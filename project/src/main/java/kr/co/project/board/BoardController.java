...
public class BoardController {
	...
	public String index(Model model, BoardVO vo) { // 전송할 모델 객체, vo 커멘드객체
	...
	public String insert(BoardVO vo, Model model,
		...
		vo.setMember_no(mv.getNo()); // mv에 있는 no만 꺼내 vo에 set
	...
	public String view(BoardVO vo, Model model) {
		...
		//cvo.setBoard_no(vo.getNo()); // 댓글리스트 view 아래에 붙여서 처리하느 방식 // 매개변수 CommentVO cvo 필요
